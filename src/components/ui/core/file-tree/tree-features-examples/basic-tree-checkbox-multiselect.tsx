...
import { Tree, TreeItem, TreeItemLabel } from '../tree-orchestrator';
...
export default function CheckboxMultiSelectTree() {
  const tree = useTree<Item>({
    ...
    dataLoader: {
      getItem: itemId => items[itemId] || { name: 'Unknown', children: [] },
