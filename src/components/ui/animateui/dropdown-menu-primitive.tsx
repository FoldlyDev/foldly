...
import {
  ...
  type HighlightProps,
} from '@/components/ui/animateui/highlight';
import { createStrictContext } from '@/lib/utils/context';
import { useControlledState } from '@/hooks/utility/use-controlled-state';
import { useDataState } from '@/hooks/utility/use-data-state';
...
const [DropdownMenuProvider, useDropdownMenu] =
  createStrictContext<DropdownMenuContextType>('DropdownMenu');

const [DropdownMenuSubProvider, useDropdownMenuSub] =
  createStrictContext<DropdownMenuSubContextType>('DropdownMenuSub');
