...
export const PrimaryCta = React.forwardRef<HTMLButtonElement, PrimaryCtaProps>(
  ({ children, className, ...props }, ref) => {
    return (
      <button 
        ref={ref}
        className={cn('primary-cta-button', className)} 
        {...props}
      >
        <div className='primary-cta-bg'></div>
        <svg
        ...
        <div className='primary-cta-wrap'>
          ...
          <div className='primary-cta-outline'></div>
          <div className='primary-cta-content'>
            {children || (
              <>
                <span className='primary-cta-char state-1'>
                  <span data-label='J' style={{ '--i': 1 } as React.CSSProperties}>
                    J
                  </span>
                  ...
                  <span data-label='n' style={{ '--i': 4 } as React.CSSProperties}>
                    n
                  </span>
                  <span data-label='T' style={{ '--i': 5 } as React.CSSProperties}>
                    T
                  </span>
                  <span data-label='o' style={{ '--i': 6 } as React.CSSProperties}>
                    o
                  </span>
                  <span data-label='d' style={{ '--i': 7 } as React.CSSProperties}>
                    d
                  </span>
                  <span data-label='a' style={{ '--i': 8 } as React.CSSProperties}>
                    a
                  </span>
                  <span data-label='y' style={{ '--i': 9 } as React.CSSProperties}>
                    y
                  </span>
                </span>

                <div className='primary-cta-icon'>
                  <div></div>
                </div>

                <span className='primary-cta-char state-2'>
                  <span data-label='J' style={{ '--i': 1 } as React.CSSProperties}>
                    J
                  </span>
                  <span data-label='o' style={{ '--i': 2 } as React.CSSProperties}>
                  ...
                  <span data-label='N' style={{ '--i': 5 } as React.CSSProperties}>
                    N
                  </span>
                  <span data-label='o' style={{ '--i': 6 } as React.CSSProperties}>
                    o
                  </span>
                  <span data-label='w' style={{ '--i': 7 } as React.CSSProperties}>
                    w
                  </span>
                </span>
              </>
