...
interface TreeContextValue<T = Record<string, unknown>> {
  indent: number;
...
function useTreeContext<T = Record<string, unknown>>() {
...
interface TreeItemProps<T = Record<string, unknown>>
...
function TreeItem<T = Record<string, unknown>>({
  item,
  className,
  asChild,
  children,
...
interface TreeItemLabelProps<T = Record<string, unknown>>
  extends React.HTMLAttributes<HTMLSpanElement> {
  item?: ItemInstance<T>;
}

function TreeItemLabel<T = Record<string, unknown>>({
  item: propItem,
  children,
  className,
  ...props
