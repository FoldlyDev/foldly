    ...
    <>
        ...
        >
          {isUploading ? (
            ...
            <>
              ...
              <span>
                Upload {stagedItemCount} Item{stagedItemCount !== 1 ? 's' : ''}
              </span>
            </>
          )}
        </Button>
      ...
      <Button
        ...
        className={
          hasStaged
            ? 'gap-2'
            : 'gap-2 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700'
        }
        style={{
          background:
            linkData.branding?.enabled && linkData.branding?.color && !hasStaged
              ? `linear-gradient(135deg, ${brandColor}, ${brandColor}dd)`
              : undefined,
        }}
      >
