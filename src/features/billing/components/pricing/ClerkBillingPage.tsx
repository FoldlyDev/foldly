...
import { PricingTable, Protect, ClerkLoading, ClerkLoaded } from '@clerk/nextjs';
        ...
        <ClerkLoading>
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[...Array(3)].map((_, i) => (
                <Card key={i} className="animate-pulse border-[var(--neutral-200)]">
            ...
            <div className="space-y-6">
              ...
              <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {[...Array(3)].map((_, i) => (
                    <Card key={i} className="border border-[var(--neutral-200)]">
        ...
        <div className="max-w-6xl mx-auto">
          <ClerkLoading>
            <ClerkPricingTableSkeleton 
              loadingMessage="Loading your subscription options..."
            />
          </ClerkLoading>
                    ...
                    <Card key={i} className="border border-[var(--neutral-200)]">
                      <CardContent className="p-6">
                        <div className="flex flex-col items-center text-center space-y-4">
                          ...
                          <div className="space-y-2">
                            <div className="text-lg font-semibold text-[var(--quaternary)]">Loading Pricing...</div>
                            <div className="text-sm text-[var(--neutral-600)]">Fetching subscription details</div>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
