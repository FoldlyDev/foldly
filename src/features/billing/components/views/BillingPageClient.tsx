...
export const BillingPageClient: React.FC<BillingPageClientProps> = React.memo(({ params }) => {
              ...
              <UserProfile 
                ...
                appearance={{
                  elements: {
                    ...
                    // Main content area
                    pageScrollBox: 'p-8 bg-gradient-to-br from-white to-[var(--neutral-50)]/30',
                    ...
                    `,
                    headerSubtitle: 'text-[var(--neutral-600)] mb-6 text-base leading-relaxed',
                    
                    // Form elements
                    formFieldLabel: 'text-[var(--quaternary)] font-medium mb-2 text-sm',
                    formFieldInput: `
