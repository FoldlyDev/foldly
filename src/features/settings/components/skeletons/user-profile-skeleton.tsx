        ...
        <CardHeader className={config.cardPadding}>
          ...
          <div className="flex gap-2 p-2 bg-[var(--neutral-50)] rounded-lg mb-6">
            {[...Array(config.tabsCount)].map((_, i) => (
              <Skeleton key={i} className={`h-8 ${i === 0 ? 'w-24' : i === 1 ? 'w-20' : 'w-16'}`} />
            ))}
          </div>
        </CardHeader>
        ...
        <CardContent className={`${config.cardPadding} pt-0`}>
          <div className={config.spacing}>
            ...
            {[...Array(config.sectionsCount)].map((_, sectionIndex) => (
              <div key={sectionIndex} className="space-y-4 pt-6 border-t border-[var(--neutral-200)]">
            ...
            {variant === 'detailed' && (
              <div className="space-y-4 pt-6 border-t border-[var(--neutral-200)]">
                ...
                <div className="space-y-3">
                  {[...Array(3)].map((_, i) => (
                    <div key={i} className="flex items-center justify-between p-3 border border-[var(--neutral-200)] rounded-lg">
...
export const ClerkUserProfileSkeleton: React.FC<Pick<UserProfileSkeletonProps, 'loadingMessage'>> = ({
...
export const DetailedUserProfileSkeleton: React.FC<Pick<UserProfileSkeletonProps, 'loadingMessage'>> = ({
