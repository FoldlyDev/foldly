...
import { Globe, Mail, Lock, ToggleLeft, ToggleRight } from 'lucide-react';
...
interface VisibilitySecuritySectionProps {
  form: UseFormReturn<GeneralSettingsFormData>;
}

export function VisibilitySecuritySection({
  form,
}: VisibilitySecuritySectionProps) {
  const {
    watch,
    setValue,
    formState: { errors },
