...
interface HomeAboutSectionRefs {
  sectionRef: React.RefObject<HTMLElement | null>;
  headerRef: React.RefObject<HTMLDivElement | null>;
  cardRefs: React.RefObject<HTMLDivElement | null>[];
}

interface UseHomeAboutSectionAnimationProps {
  refs: HomeAboutSectionRefs;
  isEnabled: boolean;
}

export function useHomeAboutSectionAnimation({
  refs,
  isEnabled,
}: UseHomeAboutSectionAnimationProps) {
  useEffect(() => {
