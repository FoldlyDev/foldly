...
function NotificationItem({
  ...
  const handleViewUploads = () => {
    ...
    router.push(
      `/dashboard/files?linkId=${notification.linkId}&highlight=true`
    );
    ...
    <motion.div
      ...
      className={cn(
        ...
        notificationType === 'error' &&
          'hover:bg-red-50 dark:hover:bg-[var(--notification-error-glass)]',
        notificationType === 'warning' &&
          'hover:bg-amber-50 dark:hover:bg-[var(--notification-warning-glass)]',
        notificationType === 'success' &&
          'hover:bg-green-50 dark:hover:bg-[var(--notification-success-glass)]',
        notificationType === 'info' &&
          'hover:bg-blue-50 dark:hover:bg-[var(--notification-info-glass)]',
        // Unread notification styling with type-based background
        !notification.isRead &&
          notificationType === 'error' &&
          'bg-red-50/50 dark:bg-[var(--notification-error-glass)]',
        !notification.isRead &&
          notificationType === 'warning' &&
          'bg-amber-50/50 dark:bg-[var(--notification-warning-glass)]',
        !notification.isRead &&
          notificationType === 'success' &&
          'bg-green-50/50 dark:bg-[var(--notification-success-glass)]',
        !notification.isRead &&
          notificationType === 'info' &&
          'bg-blue-50/50 dark:bg-[var(--notification-info-glass)]'
      )}
