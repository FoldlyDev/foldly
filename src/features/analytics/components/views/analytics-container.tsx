                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
                  ...
                  <div className='dashboard-card'>
                    ...
                    <div className='space-y-4'>
                      {(analyticsData?.topPerformingLinks?.length || 0) > 0 ? (
              ...
              >
                <div className='text-center py-16'>
                  ...
                  <p className='text-muted-foreground mb-8 leading-relaxed max-w-md mx-auto'>
                    We're building something epic for you! Soon you'll be able
                    to track all your uploads, views, and file stats in this
                    space. Stay tuned!
                  </p>
                </div>
              </motion.div>
